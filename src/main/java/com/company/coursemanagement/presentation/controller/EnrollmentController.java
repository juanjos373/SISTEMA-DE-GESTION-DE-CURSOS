...
public class EnrollmentController {
    ...
    @PostMapping
    public ResponseEntity<?> createEnrollment(@Valid @RequestBody CreateEnrollmentRequest createEnrollmentRequest) {
        try {
            CreateEnrollmentDTO created = enrollmentService.createEnrollment(createEnrollmentRequest);
    ...
    public ResponseEntity<?> findById(@PathVariable Long id) {
        try {
            CreateEnrollmentDTO enrollment = enrollmentService.findById(id);
    ...
    public ResponseEntity<?> cancelEnrollment(@PathVariable Long id) {
        try {
            CreateEnrollmentDTO cancelled = enrollmentService.cancelEnrollment(id);
